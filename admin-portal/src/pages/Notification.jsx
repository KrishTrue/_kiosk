...
const Notification = () => {
  ...
  const handleDelete = async () => {
    if (!window.confirm("Confirm identity revocation for this notice? It will be removed from all kiosks immediately.")) return;
  ...
  if (loading) return (
    <div className="ml-72 mt-24 h-[calc(100vh-6rem)] flex flex-col items-center justify-center bg-slate-50/30">
      ...
      <span className="mt-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.5em] animate-pulse">Syncing Notice Data</span>
    </div>
  );
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-0.5">
              ...
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]">Notice ID: {data._id.slice(-6).toUpperCase()}</span>
            </div>
            <h1 className="text-2xl font-black text-[#002b5c] tracking-tight">Bulletin Verification</h1>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto space-y-10">
            ...
            <div className="p-12 lg:p-16">
              <div className="flex items-center gap-6 mb-10 pb-8 border-b border-slate-50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Broadcast Date</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Network Status</p>
          ...
          <div className="flex items-center justify-center gap-8 opacity-20 py-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]">Encrypted Storage</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-1 h-1 bg-slate-400 rounded-full" />
              <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]">Audit Log #AN-{id.slice(-4)}</span>
            </div>
          </div>
