 ...
 */
const VirtualKeyboard = forwardRef<HTMLDivElement, { 
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-6 px-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.4em]">Hardware Interface</p>
              <p className="text-sm font-bold text-[#002b5c] tracking-tight uppercase italic">Active Input: {activeInputName}</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-0.5">
              ...
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.5em]">Service Uplink</span>
            </div>
            <h1 className="text-4xl font-black text-[#002b5c] tracking-tighter">Support Terminal</h1>
          </div>
        </div>
        ...
        <div className="bg-slate-50/80 backdrop-blur-md px-6 py-4 rounded-[28px] border border-slate-200 flex items-center gap-6">
           <div className="text-right">
              <div className="flex items-center justify-end gap-2 mb-1">
                 ...
                 <span className="text-[9px] font-black text-[#002b5c] uppercase tracking-widest leading-none">Diagnostic Mode Active</span>
              </div>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Environment v4.2.0</p>
           </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {isSuccess ? (
            <div className="flex flex-col items-center justify-center py-24 bg-white rounded-[50px] border border-slate-100 text-center animate-in zoom-in-95 duration-700 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.05)]">
              ...
              <h2 className="text-3xl font-black text-[#002b5c] tracking-tight mb-3 uppercase italic">Transmission Confirmed</h2>
              <p className="text-lg text-slate-400 font-medium max-w-sm mx-auto leading-relaxed">Report logged in central registry. Administrative review initiated.</p>
              <button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative group">
                    ...
                    <ChevronDown className="absolute right-6 top-1/2 -translate-y-1/2 text-[#002b5c] pointer-events-none transition-transform group-active:translate-y-0" size={24} />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <textarea 
                  ...
                  onFocus={() => {
                    ...
                    setTimeout(() => scrollRef.current?.scrollBy({ top: 300, behavior: 'smooth' }), 100);
                  }}
                  rows={5}
